    ...
    <div class="container">
        <div class="col-md-9 technology-left">
            <div class="agileinfo">
                ...
                <h2 class="w3"><?= $data['post']['title'] ?></h2>
                <div class="single">
                    <img src="images/sing-1.jpg" class="img-responsive" alt="">
                    <div class="b-bottom">
                        <p class="sub"><?= $data['post']['body'] ?></p>
                        <p>
                            <i class="glyphicon glyphicon-calendar"></i> <?= Format::dateFormat($data['post']['added_time']) ?>
                            &nbsp;&nbsp;
                            <i class="glyphicon glyphicon-eye-open"></i> <?= $data['post']['view'] ?>
                        </p>
